...
## Open findings
- [ ] **P2 — high-severity dep advisory: nanoid <3.3.18 (transitive via next).** package.json — `npm audit` 2026-08-14 reports 1 high: GHSA-2v37-7h3g-55p8, node_modules/nanoid, fixAvailable true. — fix: `npm audit fix`.
